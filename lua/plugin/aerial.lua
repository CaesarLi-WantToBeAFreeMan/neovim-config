return {
    ...
    config = function()
        require("aerial").setup({
            ...
            layout = {
                max_width = 0.5,              --maximum aerial window width
                min_width = 0.3,              --minimum aerial window width
                default_direction = "right",  --open aerial on right side
            ...
            show_guides = true,                         --display hierarchy guides
            highlight_on_hover = true,                  --highlight code on hover
            highlight_on_jump = 210,                    --keep highlight for 210 ms after jumping
            close_on_select = true,                     --close aerial on symbol selection
            update_events = "TextChanged,InsertLeave",  --refresh symbols after edits
            treesitter = {update_delay = 210},          --delay treesitter updates for performance
            lsp = {
